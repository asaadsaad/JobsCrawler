...
public class CareerBuilderParser implements IParser {
	public static final String CAREER_SITE = "http://www.careerbuilder.com";
	public static final String URL_PARSE = "http://www.careerbuilder.com/search/";
	public static final String URL_LOGIN = "https://www.careerbuilder.com/share/login.aspx";
	public static final String USERNAME = "jobscrawlerproject@gmail.com";
	public static final String PASSWORD = "JobsCrawler2015";
	...
	public boolean Authenticate(String url, String username, String password) {
		...
		try {
			...
			res = Jsoup.connect(url).timeout(Global.CONNECTION_TIMEOUT)
					.data("__VIEWSTATE", "%2FwEPDwUKLTkwMzU0MDEwOGQYAQUeX19Db250cm9sc1JlcXVpcmVQb3N0QmFja0tleV9fFgEFJ0pvYlNlZWtlckxvZ2luVjM6Y2JzeXNfbG9naW5fcmVtZW1iZXJtZfVhQrFrOD2g6e8c0G2QcDDS5vLK")
					.data("__EVENTVALIDATION", "%2FwEdAAYDd%2FVA7WZlKKa6zCVFXvjNUr96YW5C5arhk24Kv2mGbGZkRpiP35CnxRE2p21JMk7imQ4UZSTtfMl2HbIB3OWRnss74zBNm2seSwpAeZqF78hYmXduSt3gVf%2FnBL2jE3IOAy%2FY2wvnCZhdFSRRAvlLoPdN1g%3D%3D")
					.data("JobSeekerLoginV3%3Acbsys_login_email", username)
					.data("JobSeekerLoginV3%3Acbsys_login_password", password)
